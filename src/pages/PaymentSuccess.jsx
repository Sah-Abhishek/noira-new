  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        {/* Success Icon */}
        <div className="w-20 h-20 rounded-full bg-[#FFD700] flex items-center justify-center mx-auto mb-6 shadow-lg shadow-yellow-500/40">
          <CheckCircle className="w-12 h-12 text-black" />
        </div>

        {/* Heading */}
        <h1 className="text-3xl font-bold text-[#FFD700] mb-2">Payment Successful!</h1>
