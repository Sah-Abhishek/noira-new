...
const CtaSection = () => {
  ...
  return (
    <section
      className={`py-20 px-6 md:px-20 flex justify-center items-center ${isDarkMode ? 'bg-black text-white' : 'bg-white text-black'
        }`}
    >
      <div
        className={`rounded-2xl px-10 py-12 w-full max-w-5xl text-center shadow-lg border ${isDarkMode
      ...
      >
        ...
        {/* Description */}
        <p
          className={`mt-6 text-sm md:text-base ${isDarkMode ? 'text-gray-400' : 'text-gray-600'
            }`}
        >
        ...
        <div className="mt-8 flex flex-col md:flex-row gap-4 justify-center items-center">
          ...
          <Link
            to="/allservicespage"
            className={`font-semibold px-6 py-3 rounded-full border transition ${isDarkMode
