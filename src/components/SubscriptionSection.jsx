...
import { FaCheck, FaCalendar, FaStar, FaGift, FaCrown, FaShieldHalved, FaClock } from "react-icons/fa6";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <SubscriptionCard
            ...
            best
            extra={[
              { icon: <FaStar />, text: "1 complimentary (10 total)" },
            ]}
            benefits={[
        ...
        <div className="text-center mt-16">
          <p className="text-gray-400 text-sm mb-6 flex justify-center items-center">
            <FaShieldHalved className="mr-2 text-primary" />
  ...
  return (
    ...
    >
        ...
        <div className="bg-gradient-to-r from-primary/20 to-yellow-200/10 border border-primary/40 rounded-xl p-3 mb-6 space-y-2 text-center">
          ...
          {extra &&
            extra.map((e, i) => (
              ...
              >
                {e.icon} <span className="ml-2">{e.text}</span>
              </div>
            ))}
        </div>
      )}
      ...
      <div className="space-y-6 mb-8 text-center">
        ...
        <div className="text-gray-400 text-sm">{pricing[duration].duration}</div>
      </div>
      ...
      <div className="space-y-3 mb-8">
        {benefits.map((b, i) => (
          <div key={i} className="flex items-center text-gray-300">
            <span className="text-primary mr-3">{b.icon}</span>
            <span>{b.text}</span>
          </div>
        ))}
      </div>
