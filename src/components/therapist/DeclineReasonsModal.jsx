...
const DeclineReasonsModal = ({ isOpen, onClose, onSubmit, bookingId, clientName }) => {
  ...
  const predefinedReasons = [
    'Schedule conflict - unable to accommodate requested time',
    'Outside my area of specialization',
    'Currently at capacity with existing clients',
    'Technical issues with the booking system',
    'Need to reschedule due to emergency',
    'Client requirements do not match my services',
        ...
        <div className="p-6">
          ...
          <div className="mt-4 p-3 bg-[#0d0d0d] rounded-lg border border-primary/20">
            <p className="text-xs text-gray-400 leading-relaxed">
              <span className="text-primary font-medium">Note:</span> The client will be notified of your decision.
              We recommend being honest and professional in your communication to maintain trust and help clients find suitable alternatives.
            </p>
          </div>
        </div>
      </div>
